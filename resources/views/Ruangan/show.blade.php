            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="/e-peminjamans/tambahLemari/{{ $id }}"
                            class="btn btn-primary btn-rounded btn-fw"><i class="icon-nav fa fa-plus"></i> Tambah Data</a>
                            ...
                            <tbody>
                                @foreach ($dataLemari as $row)
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="/e-peminjamans/tambahRak/{{ $row->id }}">
                                                            Tambah Rak</a>
                                                        <a class="dropdown-item"
                                                            href="/e-peminjamans/detailRak/{{ $row->id }}">
                                                            Detail Rak</a>
                                                        <a class="dropdown-item"
                                                            href="/e-peminjamans/editLemari/{{ $row->id }}">
                                                            Edit</a>
                                                        <a class="dropdown-item" href="/hapusLemari/{{ $row->id }}"
                                                            data-toggle="modal"
                                    ...
                                    <div class="modal fade right" id="modalhapus{{ $row->id }}" tabindex="-1"
                                        ...
                                        <form action="/e-peminjamans/hapusLemari/{{ $row->id }}" method="POST">
                                            @csrf
                                            {{ method_field('DELETE') }}
