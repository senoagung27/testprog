        ...
        <section class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="/e-peminjamans/SimpanEditRuangan">
                        @csrf
                        <input type="hidden" name="id" value="{{ $dataRuangan->id }}">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nama Ruangan</label>
                                <input type="text" name="nama_ruangan" class="form-control"
                                    value="{{ $dataRuangan->nama_ruangan }}">
                            </div>
                        </div>
                        <!-- /.card-body -->
                        ...
                        <div class="card-footer">
                            ...
                            <a href="/e-peminjamans/InfoRuangan" class="btn btn-success fa-pull-right">Back</a>
                        </div>
                    </form>
                </div>
            </div>
