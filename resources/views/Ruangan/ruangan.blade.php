            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-flat" href="/e-peminjamans/Ruangan"> <i class="fas fa-building sm"></i> Info
                            Ruangan</a>
                            ...
                            <tbody>
                                @foreach ($dataRuangan as $row)
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                            href="/e-peminjamans/DetailRuangan/{{ $row->id }}">
                                                            Detail</a>
                                                        <a class="dropdown-item"
                                                            href="/e-peminjamans/editRuangan/{{ $row->id }}">
                                                            Edit</a>
                                                        <a class="dropdown-item"
                                                            href="/e-peminjamans/hapusRuangan/{{ $row->id }}"
                                                            data-toggle="modal"
                                    ...
                                    <div class="modal fade right" id="modalhapus{{ $row->id }}" tabindex="-1"
                                        ...
                                        <form action="/hapusRuangan/{{ $row->id }}" method="POST">
                                            @csrf
                                            {{ method_field('DELETE') }}
