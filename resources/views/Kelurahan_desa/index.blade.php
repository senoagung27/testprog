    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Kelurahan</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <form method="POST" action="/e-peminjamans/Kelurahan/Import" enctype="multipart/form-data">
                            ...
                            <tbody>
                                @foreach ($dataKelurahan as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->nama }}</td>
                                        <td>
                                            @if ($row->isiKecamatan != null)
                                                @foreach ($datan->isiKecamatan as $datan3)
