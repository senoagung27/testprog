        ...
        <section class="content">
            <div class="container-fluid">
                                    ...
                                    <div class="modal fade" id="modal-default{{ $data->id }}">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form role="form" method="POST" action="/e-peminjamans/updateStatus">
                                                    @csrf
                                                            ...
                                                            <div class="col-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        {{-- <select class="custom-select" name="ruangan_id" required>
                                                            ...
                                                            <div class="col-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        {{-- <select name="lemari_id" class="custom-select">
                                                            ...
                                                            <div class="col-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        {{-- <select name="rak_id" class="custom-select">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form role="form" method="POST" action="/e-peminjamans/SimpanKeranjangBaru">
                            @csrf
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nomor" class="form-control" id="reservation"
                    ...
                    <div class="callout callout-success ml-2">
                        <form role="form" method="POST" action="/e-peminjamans/SimpanTransaksiBaru">
                            @csrf
