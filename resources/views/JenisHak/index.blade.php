    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Jenis Hak</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/e-peminjamans">Home</a></li>
                            <li class="breadcrumb-item active">Jenis Hak</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('jenishak.create') }}" class="btn btn-primary btn-rounded btn-fw"><i
                    ...
                    <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <form method="POST" action="/e-peminjamans/JenisHak/Import" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($dataJenisHak as $row)
                                    <tr>
                                        <td>{{ $row->nama_jenis_hak }}</td>
                                        <td>
                                    ...
                                    <div class="modal fade right" id="modalhapus{{ $row->id }}" tabindex="-1"
                                        ...
                                        <form action="/e-peminjamans/hapusJenisHak/{{ $row->id }}" method="POST">
                                            @csrf
                                            {{ method_field('DELETE') }}
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-9">
                                                                ...
                                                                <h2><span
                                                                        class="badge">{{ $row->nama_berkas }}</span>
                                                                </h2>
                                                            </div>
                                                        </div>
                                                    </div>
