            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-header d-flex p-0">
                        <a href="/Laporan/Transaksi" class="d-flex ml-3">
                            ...
                            <tbody>
                                    @foreach ($dataCari as $data)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $data->isiJenis->nama_jenis_hak }}
                                            </td>
                                            <td>
                                                {{ $data->isiKecamatan->name }}
                                            </td>
                                            <td>
                                                {{ $data->isiKelurahan->name  }}
                                            </td>
                                            <td>{{ $data->isiTransaksi }}</td>
                                            ...
                                            <td>
                                                 <ul>
                                                @foreach ($data->isiRincian as $data)
                                                <li> {{ $data->isiTransaksi->tanggal_ambil_berkas}}</li>
                                               
                                                @endforeach                                                 
                                                </ul>
                                               
                                            </td>
                                            <td>{{ $data->tanggal_pengembalian_berkas}}</td>
                                            ...
                                            <td>
                                                <ul>
                                                    @foreach ($data->isiRincian as $item)
                                                        <li>{{ $item->isiBerkas }}</li>
                                                    @endforeach                                                   
                                                </ul>
                                            </td>
                                            ...
                                            <td class="project-state">
                                                @if ($data->status_pinjam === 'Pinjam')
                                                    <span class="badge badge-success">{{ $data->status_pinjam }}</span>
                                            ...
                                            <div class="modal-dialog modal-notify modal-danger" role="document">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        ...
                                                        <a type="button" class="btn btn-outline-danger waves-effect" style="color:white"
