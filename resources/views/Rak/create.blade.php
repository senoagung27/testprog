        ...
        <section class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="/e-peminjamans/Simpanrak">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nama Rak</label>
                                <input type="hidden" name="lemari_id" value="{{ $id }}"/>
                                <input type="text" name="nama_rak" class="form-control" id="exampleInputPassword1"
